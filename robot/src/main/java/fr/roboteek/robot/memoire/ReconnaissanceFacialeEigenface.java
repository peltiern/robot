...
public class ReconnaissanceFacialeEigenface extends ReconnaissanceFaciale {
    ...
    public ReconnaissanceFacialeEigenface() {
        ...
        fichierReconnaissanceFaciale = new File(System.getenv(Constantes.ENV_VAR_ROBOT_HOME) + File.separator + "reconnaissance-faciale" + File.separator + "moteurReconnaissanceEigenFace.sav");

...
/**
 * Détecteur d'objets utilisant le réseau de neurones Yolo V2.
 */
public class YoloV2Detector extends ObjectDetector<String> {
    ...
    private static final YoloV2Detector INSTANCE = new YoloV2Detector();

    private YoloV2Detector() {
        try {
    ...
    public static YoloV2Detector getInstance() {
        return INSTANCE;
    }

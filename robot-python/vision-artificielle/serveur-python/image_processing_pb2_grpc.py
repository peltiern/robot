...
class ImageProcessingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.deleteFace = channel.unary_unary(
                '/fr.roboteek.robot.services.visionartificielle.dto.image.ImageProcessingService/deleteFace',
                request_serializer=image__processing__pb2.DeleteFaceRequest.SerializeToString,
...
def add_ImageProcessingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'deleteFace': grpc.unary_unary_rpc_method_handler(
                    servicer.deleteFace,
                    request_deserializer=image__processing__pb2.DeleteFaceRequest.FromString,
...
class ImageProcessingService(object):
    ...
    def deleteFace(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/fr.roboteek.robot.services.visionartificielle.dto.image.ImageProcessingService/deleteFace',
            image__processing__pb2.DeleteFaceRequest.SerializeToString,
